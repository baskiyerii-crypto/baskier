@php
    ...
    $brandClass = $isMobileHeader
        ? 'inline-flex min-w-0 max-w-full items-center gap-2.5 text-base font-extrabold tracking-tight text-slate-900'
        : (($compact ?? false)
    ...
    $logoBox = $isMobileHeader ? 'h-11 w-11 shrink-0' : 'h-9 w-9 shrink-0';
